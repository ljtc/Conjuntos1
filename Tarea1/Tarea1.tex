...
\DeclareExerciseTranslations{exercise}{Spanish = ejercicio}
\DeclareExerciseTranslations{exercises}{Spanish = ejercicios}
\DeclareExerciseTranslations{solution}{Spanish = solución}
\DeclareExerciseTranslations{solutions}{Spanish = soluciones}
\DeclareExerciseTranslations{default-heading}{
  Spanish = \XSIMmixedcase{\GetExerciseParameter{solutions-name}} de los 
  \XSIMmixedcase{\GetExerciseParameter{exercises-name}}
}
...
\pagenumbering{gobble}
    ...
    %No escribir manualmente una línea punteada. Si se cambia la geometría de la
    %página o el tamaño de letra, la línea no se ajustará automáticamente.
