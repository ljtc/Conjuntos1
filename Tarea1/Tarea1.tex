...
\pagenumbering{gobble}
    ...
    \begin{exercise}[print=true]
        Sean $X,Y$ conjuntos y $f:X \to Y$. Se define la función $g:\mathscr{P}(X)\to \mathscr{P}(Y)$ para cada $a \in \mathscr{P}(X)$ como $ g(a)=\Set{ y \in Y \st f^{-1}[\{y\}] \subseteq a } $.
        \begin{enumerate}[i)]
            \item Demuestra que si $a \in \mathscr{P}(X)$ y $b \in \mathscr{P}(Y)$, entonces $b \subseteq g(a)$ si y sólo si $f^{-1}[b] \subseteq a$.
            \item Prueba que para todo $A \in \mathscr{P}(\mathscr{P}(X)) \setminus \{\emptyset\}$ se tiene $g(\bigcap A)=\bigcap \Set{g(a) \st a \in A}$.
        \end{enumerate}
    \end{exercise}
\end{document}
